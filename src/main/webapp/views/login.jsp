        ...
        <div class="col-md-5">
            <div class="card shadow-sm border-0 rounded-4 p-4 bg-white">
                ...
                <ul class="nav nav-pills nav-justified mb-4 bg-light p-1 rounded-pill">
                    <li class="nav-item">
                        <a class="nav-link active rounded-pill fw-bold py-2" href="${pageContext.request.contextPath}/login">ĐĂNG NHẬP</a>
                    </li>
                    <li class="nav-item">
                ...
                <form action="${pageContext.request.contextPath}/login" method="post">
                    ...
                    <button type="submit" class="btn btn-dark w-100 py-2 fw-bold rounded-pill mb-3">Đăng nhập</button>
                </form>
            </div>
        </div>
    </div>
